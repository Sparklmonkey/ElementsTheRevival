...
public class WelcomeQuest : IQuest
{
    ...
    public string QuestReward => "Reward: 10 <sprite=0>";
...
public class ImproveDeckQuest : IQuest
{
    ...
    public string QuestReward => "Reward: 20 <sprite=0>";
...
public class BazaarQuest : IQuest
{
    ...
    public string QuestReward => "Reward: 30 <sprite=0>";
...
public class ElementalOneQuest : IQuest
{
    ...
    public string QuestReward => "Reward: 35 <sprite=0>";
...
public class ElementalTwoQuest : IQuest
{
    ...
    public string QuestReward => "Reward: 40 <sprite=0>";
...
public class ScoreOneQuest : IQuest
{
    ...
    public string QuestReward => "Reward: 150 <sprite=0>";
