...
{
    public static void PlayAnimation(string animName, Transform transform, ActionEffect effect, Element element = Element.Other)
    {
        ...
        GameObject anim = Instantiate(Resources.Load<GameObject>("Prefabs/Animation"), transform);
        ...
        anim.GetComponent<ImageAnimations>().PlayAnimation(sprites, effect, color);
    }

    private static (Vector2, Vector2) GetLightningAnimModification(Vector2 parentSize)
    {
    ...
    private static (Vector2, Vector2) GetCardDeathAnimModification(Vector2 parentSize)
    {
    ...
    private static (Vector2, Vector2) GetMutationAnimModification(Vector2 parentSize)
    {
    ...
    private static (Vector2, Vector2) GetBlessingAnimModification(Vector2 parentSize)
    {
    ...
    private static (Vector2, Vector2) GetMitosisAnimModification(Vector2 parentSize)
    {
    ...
    private static (Vector2, Vector2) GetPurifyAnimModification(Vector2 parentSize)
    {
        Vector2 baseImageSize = new Vector2(106, 106);
        Vector2 effectSize = new Vector2(73, 74);
        Vector2 offset = new Vector2(0f, 0f);
    ...
    private static (Vector2, Vector2) GetElementGenerateAnimModification(Vector2 parentSize)
    {
    ...
    private static (Vector2, Vector2) GetDiveAnimModification(Vector2 parentSize)
    {
    ...
    private static (Vector2, Vector2) GetSniperAnimModification(Vector2 parentSize)
    {
    ...
    private static (Vector2, Vector2) GetRagePotionAnimModification(Vector2 parentSize)
    {
    ...
    private static (Vector2, Vector2) GetParallelUniverseAnimModification(Vector2 parentSize)
    {
    ...
    private static (Vector2, Vector2) GetStealAnimModification(Vector2 parentSize)
    {
        Vector2 baseImageSize = new Vector2(106, 106);
        Vector2 effectSize = new Vector2(73, 74);
        Vector2 offset = new Vector2(0f, 0f);
    ...
    private static (Vector2, Vector2) GetWebAnimModification(Vector2 parentSize)
    {
    ...
    private static (Vector2, Vector2) GetDeadAndAliveAnimModifiers(Vector2 parentSize)
    {
    ...
    private static (Vector2, Vector2) GetDrainLifeAnimModification(Vector2 parentSize)
    {
    ...
    private static (Vector2, Vector2) GetIceBoltAnimModification(Vector2 parentSize)
    {
    ...
    private static Vector2 GetAdjustedOffset(Vector2 neededSize, Vector2 baseImageSize, Vector2 offset)
    {
        Vector2 result = new Vector2(offset.x / baseImageSize.x * neededSize.x, offset.y / baseImageSize.y * neededSize.y);
        return result;
    }

    private static Vector2 GetAdjustedSize(Vector2 neededSize, Vector2 baseImageSize, Vector2 effectSize)
    {
