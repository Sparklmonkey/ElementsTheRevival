...
public class PassiveCardDisplay : MonoBehaviour
{
    
    [SerializeField]
    private Image cardImage, activeAElement, validTargetGlow, isUsableGlow;
    [SerializeField]
    private TextMeshProUGUI activeAName, activeACost, turnsInPlay;
    [SerializeField]
    ...
    private void HideCard(ClearCardDisplayEvent clearCardDisplayEvent)
    {
        ...
        {
            EventBus<ModifyPlayerCounterEvent>.Raise(new ModifyPlayerCounterEvent(PlayerCounters.Bone, Id.owner, -9999));
        }
