...
namespace UnityAsyncAwaitUtil
{
    public class AsyncUtilTests : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("_buttonSettings")] [SerializeField]
        private TestButtonHandler.Settings buttonSettings = null;

        private TestButtonHandler _buttonHandler;

        public void Awake()
        {
            _buttonHandler = new TestButtonHandler(buttonSettings);
        }
        ...
        {
            Debug.Log("Waiting for ienumerator...");
            var result = (string)await WaitForStringUntyped();
